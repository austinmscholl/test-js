looker.plugins.visualizations.add({
  ...
  create: function(element, config) {
    ...
    element.innerHTML = `
       <style>
      .nurture-and-hope-vis {
        height: 100%;
        display: grid;
      }
      .nurture-and-hope-image {
        grid-column-start: 1;
        grid-column-end: 2;
        grid-row-start: 1;
        grid-row-end: 3;
    ...
    container.className = "nurture-and-hope-vis";
    ...
    this._imageElement.innerHTML = "<img src=\"https://i.ibb.co/0f7kDNB/Nurture-And-Hope.png\" width=\"200px\" height=\"80px\">";
    this._imageElement.className =  "nurture-and-hope-image";
    ...
    // this._nameElement.innerHTML = "Nurture & Hope";
