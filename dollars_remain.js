looker.plugins.visualizations.add({
  ...
  create: function(element, config) {
    ...
    container.className = "dollars-remain-vis";
    ...
    this._imageElement.innerHTML = "<img src=\"https://i.ibb.co/dLsg6mT/Dollars-Remain.png\" width=\"200px\" height=\"80px\">";
    this._imageElement.className =  "dollars-remain-image";
    ...
    // this._nameElement.innerHTML = "Dollars Remain";
